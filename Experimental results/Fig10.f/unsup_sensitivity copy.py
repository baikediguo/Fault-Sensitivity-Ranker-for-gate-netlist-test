...
def main():
    ...
    parser.add_argument('--timing_csv', type=str, default='timing_100runs.csv', help="保存每个 topk 子图的时间信息")
    parser.add_argument('--gnn_ranks', type=str, default='gnn_ranks_100runs', help="GNN 排名结果输出目录")
